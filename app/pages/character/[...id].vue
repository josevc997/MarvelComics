    ...
    <div>
        <template v-if="character">
            ...
            <ComicList
                ...
                :comic-list="characterStore.selectedCharacter.comics"
            />
            <SerieList
                :loading="loadingSeries"
                :serie-list="characterStore.selectedCharacter.series"
            />
            <EventList
                :loading="loadingEvents"
                :event-list="characterStore.selectedCharacter.events"
            />
            <StoryList
                :loading="loadingStories"
                :story-list="characterStore.selectedCharacter.stories"
            />
        </template>
        <template v-else>
